# `@sebastienrousseau/cpp-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/cpp-config`.
...
- [x] **.clang-format**: Standardized rule preset
- [x] **.clang-tidy**: Standardized rule preset
- [x] **cmake-format.py**: Standardized rule preset
