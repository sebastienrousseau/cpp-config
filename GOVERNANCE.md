...
This document describes how @sebastienrousseau/cpp-config is run: who decides what, how
...
@sebastienrousseau/cpp-config is **maintainer-led**. As of the current release line it has a single
